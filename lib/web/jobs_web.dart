...
class JobsWeb extends StatefulWidget {
  const JobsWeb({
    Key? key,
  ...
  @override
  State<JobsWeb> createState() => _JobsWebState();
}

class _JobsWebState extends State<JobsWeb> {
  @override
    ...
    return Row(
      ...
      children: [
        ...
        jobsDetailWidget(
          ...
          widget.isShowingEnglish ? textJobsAccefyTimeEN : textJobsAccefyTimeSP,
          accefyTech,
        ),
        const SizedBox(width: 10),
        jobsDetailWidget(
